...
function [V2,PSINNORY,PSINNORX,V1,KAPPAX,KAPPAY,Nx_v,Ny_v]=SCSA_2D1D(img,h,fe,gm)
global disp_msg Mem_SCSA Time_SCSA
disp_msg=1;
tic
n = size(img,1);
  PSINNORY = zeros(n,n,n,'single');
  KAPPAY = zeros(n,n,'single');
  KAPPAX = zeros(n,n,'single');
  NY = zeros(n,1,'single');
